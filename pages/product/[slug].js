    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-16 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/51H2u5sBL1L._AC_UX569_.jpg" />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h2 className="text-sm title-font text-gray-500 tracking-widest">Kinnuhos</h2>
            <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Buy The Perfect</h1>
            ...
            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              <div className="flex">
                ...
                {Object.keys(variants).includes("black") && Object.keys(variants['black']).includes(size) &&<button className={`border-2 border-gray-300 bg-gray-700 rounded-full w-6 h-6 focus:outline-none`}></button>}
                ...
                {Object.keys(variants).includes("white") &&Object.keys(variants['white']).includes(size) &&<button className={`border-2 border-gray-300 ml-1 bg-white-500 rounded-full w-6 h-6 focus:outline-none`}></button>}
              </div>
            ...
            <div className="flex">
              ...
              <button className="flex ml-4 text-white bg-green-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-green-600 rounded" onClick={() => { addToCart(slug, 1, 499, 'XL', 'Tshirt', 'Brown') }}>Add to Cart</button>
